...
/**
 * Implementation of {@link com.github.wbw.retry.backoff.ExponentialBackOffPolicy} that
 * chooses a random multiple of the interval that would come from a simple deterministic
 * exponential. The random multiple is uniformly distributed between 1 and the
 * deterministic multiplier (so in practice the interval is somewhere between the next and
 * next but one intervals in the deterministic case). This is often referred to as jitter.
 *
...
public class ExponentialRandomBackOffPolicy extends ExponentialBackOffPolicy {
	...
	/**
	 * Returns a new instance of {@link com.github.wbw.retry.backoff.BackOffContext},
